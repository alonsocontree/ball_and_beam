function gui_distancia_plot()
    ...
    slider = uislider(f, 'Limits', [5 40], 'Value', 25, 'Position', [130 770 200 3]);
                ...
                while ~isempty(idx)
                    ...
                    if numel(partes) == 2
                        ...
                        if ~isnan(dist_mm) && ~isnan(angulo)
                            ...
                            error_actual = setpoint - distancia;
